...
import { getFormTemplates, ResponseFormatter } from "../../utils/formResponseFormatter";
...
export async function submitFormbyId(user_id: string, form_id: string, fields: any){
...
export async function getAllSubmissionByUserId(user_id: string){
    ...
    formResponses.forEach( (cur) => { id_array.push( cur.form_id )})
